...
get_yearbook_paths <- function(custom_base_dir = NULL) {
  if (is.null(custom_base_dir)) {
    ...
    if (dir.exists("C:/Users/clair/OneDrive/Desktop/Final_Yearbook_2025")) {
      base_dir <- "C:/Users/clair/OneDrive/Desktop/Final_Yearbook_2025"
    } else {
  ...
  paths <- list(
    ...
    programs = file.path(base_dir, "FTN Yearbook functions/processing")
  )
